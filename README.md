...
года. Строка `Analytics groups` показывает, сколько групп исключено как
метагруппы или группы с явно нулевым числом учеников. Отсутствие
`student_count` не считается нулём.
